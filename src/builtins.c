...
static void	save_stdin_and_stdout(int *stdin_fd_copy, int *stdout_fd_copy)
{
...
static void	restore_and_close_stdin_and_stdout(int stdin_copy, int stdout_copy)
{
...
void		do_builtin(t_command *cmd, t_list **environ, int idx,
															int *last_status)
{
